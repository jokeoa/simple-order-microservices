...
type OrderStatusUpdate struct {
	...
	PaymentTransactionId string                 `protobuf:"bytes,4,opt,name=payment_transaction_id,json=paymentTransactionId,proto3" json:"payment_transaction_id,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *OrderStatusUpdate) GetPaymentTransactionId() string {
	if x != nil {
...
const file_order_v1_order_proto_rawDesc = "" +
	...
	"\x16payment_transaction_id\x18\x04 \x01(\tR\x14paymentTransactionId2`\n" +
	"\fOrderService\x12P\n" +
	"\x17SubscribeToOrderUpdates\x12\x16.order.v1.OrderRequest\x1a\x1b.order.v1.OrderStatusUpdate0\x01BLZJgithub.com/jokeoa/simple-order-microservices/internal/gen/order/v1;orderv1b\x06proto3"
...
var file_order_v1_order_proto_depIdxs = []int32{
	2, // 0: order.v1.OrderStatusUpdate.timestamp:type_name -> google.protobuf.Timestamp
