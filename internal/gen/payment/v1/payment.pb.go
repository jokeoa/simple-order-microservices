...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x0ecustomer_email\x18\x03 \x01(\tR\rcustomerEmail\"S\n" +
	"\x13ListPaymentsRequest\x12\x1d\n" +
	"\n" +
	"min_amount\x18\x01 \x01(\x03R\tminAmount\x12\x1d\n" +
	"\n" +
	"max_amount\x18\x02 \x01(\x03R\tmaxAmount\"\xaa\x01\n" +
	"\x0fPaymentResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12%\n" +
	"\x0etransaction_id\x18\x03 \x01(\tR\rtransactionId\x12=\n" +
	"\fprocessed_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vprocessedAt\"O\n" +
	...
	"\fListPayments\x12\x1f.payment.v1.ListPaymentsRequest\x1a .payment.v1.ListPaymentsResponseBPZNgithub.com/jokeoa/simple-order-microservices/internal/gen/payment/v1;paymentv1b\x06proto3"
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	...
	2, // 1: payment.v1.ListPaymentsResponse.payments:type_name -> payment.v1.PaymentResponse
	0, // 2: payment.v1.PaymentService.ProcessPayment:input_type -> payment.v1.PaymentRequest
	1, // 3: payment.v1.PaymentService.ListPayments:input_type -> payment.v1.ListPaymentsRequest
